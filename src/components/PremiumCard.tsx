  ...
  return (
    <div
      className={`flex flex-col justify-between rounded-2xl shadow-lg p-6 bg-gray-900 border transition-all duration-300
        ${selected ? "border-primary scale-105 ring-2 ring-primary/40" : "border-gray-800 hover:border-primary/60"}
    ...
    >
      ...
      <button
        ...
        className={`w-full py-2 rounded-full font-semibold transition text-white mt-2
          ${selected ? "bg-primary shadow-lg hover:bg-primary/90" : "bg-gray-800 hover:bg-primary/80"}`}
      >
        Subscribe
      </button>
    </div>
